function [] = plotNWBdata_PPNsilencing()
% original code to plot NWB data @ https://neurodatawithoutborders.github.io/matnwb/tutorials/html/basicUsage.html
% modified the original code by Hidehiko to plot PPN perturbation data 2/23/2022 
...
nwb = nwbRead('out/HI215_071519.nwb');
...
%         '"3"--  PPN silneicng 1.2s 0.25mW; stim start at 600ms after the Go cue ',...
    ...
    unit_stim   = unit_good_trials & 3 == unit_stim_type; % Perturbation 0.25mW
    ...
    stim_L = sum((trial_in_range.HitL | trial_in_range.ErrL | trial_in_range.NoLickL) &...
        trial_in_range.GoodTrials & trial_in_range.PhotostimulationType == 3);
    ...
    % Perturbation with 0.25mW
    if any(unit_stim)
        Stim = Photostim;
        Stim.ind = unit_stim;
        Stim.name = 'Perturbation 0.25mW';
        Stim.stim_duration = 1.2;
        Stim.stim_onset    = -0.6; % to go cue (s)
...
if strcmp(ConditionPlot.stim_type, 'Perturbation 0.25mW') 
